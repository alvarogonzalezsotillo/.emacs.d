...
get_pc_combination(){
  ...
  then
    echo Voy a leer la combinacion: $msg
    combination=${msg:19:3}
  fi
  log combination es $combination
}
...
-rwxr-xr-x  1 toukmond restricted    10423 Jan 1 1970 echoTECLEO: cd ..
...
-rwxr-xr-x  1 toukmond restricted        0 Jan 1 1970 TECLEO: ls
shovel.o
...
-rwxr-xr-x  1 toukmond restricted        0 Jan 1 1970 key.o
-rwxr-xr-x  1 toukmond restricted        0 Jan 1 1970 bracelet.TECLEO: uncompress paper.o.Z
o
$ $ TECLEO: exit
...
>TECLEO: flush urinal
TECLEO:
Whoooosh!!COMENTARIO: # voy a mirar lo que me falta: long ns hallway
...
Current time is 19:43:20
Enter new time: msg es >>Current time is 19:43:20 Enter new time:
ES UNA ORDEN PARA EL PC:
A> msg es >>Current time is 19:43:20 Enter new time: A>
COMENTARIO: #>dir
ES UNA ORDEN PARA EL PC: type foo.txt

The combination is 296.
A> msg es The combination is 296. A>
Voy a leer la combinacion: The combination is 296. A>
