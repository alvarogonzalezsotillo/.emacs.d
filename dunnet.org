...
# Excluding the endgame, how many places are there where you can put treasures for points? -> 4
# What is the nearest whole dollar to the price of the shovel? -> 20
# Which street in town is named after a U.S. state? -> Vermont
# What network protocol is used between pokey and gamma? -> ftp
# How many pounds did the weight weigh? -> 10
# What cartoon character is on the towel? -> snoopy
# What is the name of the bus company serving the town? -> mobytours
# What password did you use during anonymous ftp to gamma? -> worms
# Name either of the two objects you found by digging. -> cpu, plantinum bar 
# Give either of the two last names in the mailroom, other than your own. -> Collier, Stock
# What is your password on the machine called ‘pokey’? -> robert
# How many megabytes of memory is on the CPU board for the Vax? -> 2
# Name the STREET which runs right over the subway stop. -> Vermont
...
n
# What is your login name on the ‘endgame’ machine? -> toukmond
# What type of bear was hiding your key? -> ferocious
# How many corners are there in town (excluding the one with the Post Office)? -> 24
# What is the last name of the author of EMACS? -> stallman
# Excluding the endgame, how many places are there where you can put treasures for points? -> 4
# What is the nearest whole dollar to the price of the shovel? -> 20
...
Current time is 17:07:23
Enter new time: msg es >>Current time is 17:07:23 Enter new time:
ES UNA ORDEN PARA EL PC:
A> msg es >>Current time is 17:07:23 Enter new time: A>
COMENTARIO: #>dir
ES UNA ORDEN PARA EL PC: type foo.txt

The combination is 948.
A> msg es The combination is 948. A>
Voy a leer la combinacion: The combination is 948. A> : 948
...
Endgame N/S hallway
You are in a north/south hallway.
>COMENTARIO: # What is your login name on the ‘endgame’ machine? -> toukmond
COMENTARIO: # What type of bear was hiding your key? -> ferocious
COMENTARIO: # How many corners are there in town (excluding the one with the Post Office)? -> 24
COMENTARIO: # What is the last name of the author of EMACS? -> stallman
COMENTARIO: # Excluding the endgame, how many places are there where you can put treasures for points? -> 4
COMENTARIO: # What is the nearest whole dollar to the price of the shovel? -> 20
COMENTARIO: # Which street in town is named after a U.S. state? -> Vermont
COMENTARIO: # What network protocol is used between pokey and gamma? -> ftp
COMENTARIO: # How many pounds did the weight weigh? -> 10
COMENTARIO: # What cartoon character is on the towel? -> snoopy
COMENTARIO: # What is the name of the bus company serving the town? -> mobytours
COMENTARIO: # What password did you use during anonymous ftp to gamma? -> worms
COMENTARIO: # Name either of the two objects you found by digging. -> cpu, plantinum bar
COMENTARIO: # Give either of the two last names in the mailroom, other than your own. -> Collier, Stock
COMENTARIO: # What is your password on the machine called ‘pokey’? -> robert
COMENTARIO: # How many megabytes of memory is on the CPU board for the Vax? -> 2
COMENTARIO: # Name the STREET which runs right over the subway stop. -> Vermont
TECLEO:
