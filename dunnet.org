...
Current time is 13:47:45
Enter new time: msg es >>Current time is 13:47:45 Enter new time:
ES UNA ORDEN PARA EL PC:
A> msg es >>Current time is 13:47:45 Enter new time: A>
COMENTARIO: #>dir
ES UNA ORDEN PARA EL PC: type foo.txt

The combination is 646.
A> msg es The combination is 646. A>
Voy a leer la combinacion: The combination is 646. A> : 646
...
COMENTARIO: # How many megabytes of memory is on the CPU board for the Vax?
COMENTARIO: # Name the STREET which runs right over the subway stop.
TECLEO:
>TECLEO:
>TECLEO:
>TECLEO:
