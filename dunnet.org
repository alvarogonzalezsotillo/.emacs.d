...
# Excluding the endgame, how many places are there where you can put treasures for points?
...
Current time is 18:09:56
Enter new time: msg es >>Current time is 18:09:56 Enter new time:
ES UNA ORDEN PARA EL PC:
A> msg es >>Current time is 18:09:56 Enter new time: A>
COMENTARIO: #>dir
ES UNA ORDEN PARA EL PC: type foo.txt

The combination is 209.
A> msg es The combination is 209. A>
Voy a leer la combinacion: The combination is 209. A> : 209
...
Your question is:
What is your password on the machine called ‘pokey’?
>COMENTARIO: # What is your login name on the ‘endgame’ machine?
COMENTARIO: # What type of bear was hiding your key?
COMENTARIO: # How many corners are there in town (excluding the one with the Post Office)?
COMENTARIO: # What is the last name of the author of EMACS?
COMENTARIO: # Excluding the endgame, how many places are there where you can put treasures for points?
COMENTARIO: # What is the nearest whole dollar to the price of the shovel?
COMENTARIO: # Which street in town is named after a U.S. state?
COMENTARIO: # What network protocol is used between pokey and gamma?
COMENTARIO: # How many pounds did the weight weigh?
COMENTARIO: # What cartoon character is on the towel?
COMENTARIO: # What is the name of the bus company serving the town?
COMENTARIO: # What password did you use during anonymous ftp to gamma?
COMENTARIO: # Name either of the two objects you found by digging.
COMENTARIO: # Give either of the two last names in the mailroom, other than your own.
COMENTARIO: # What is your password on the machine called ‘pokey’?
