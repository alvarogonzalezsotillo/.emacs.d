#+TITLE: Configuración Emacs hola
...
(use-package helm-posframe
  ...
  (setq helm-posframe-border-width 20)
...
* Edición
** Acentos en KDE
Desde que uso Plasma no funcionan bien los acentos:
#+begin_src emacs-lisp
(require 'iso-transl)
#+end_src
...
(add-to-list 'load-path "/home/alvaro/github/centaur-tabs")
...
#+begin_src emacs-lisp
  ...
  (defvar mis-teclas-minor-mode-map
    (let ((map (make-sparse-keymap)))
      ...
      (define-key map (kbd "<M-return>") 'origami-close-all-nodes)
...
* nada
  ...
  #+begin_src emacs-lisp
(message "%s" (diff-hl-changes)) 
  #+end_src

  #+RESULTS:
  : ((1 1 change) (165 1 insert) (423 1 insert) (798 6 change) (805 1 change) (807 9 change) (948 10 change) (960 8 insert) (971 3 insert) (984 2 change) (1393 1 insert) (1396 3 insert) (1490 1 insert) (1650 1 delete) (2383 2 insert) (2391 1 delete) (2392 1 delete) (2429 1 delete) (2563 9 insert))
