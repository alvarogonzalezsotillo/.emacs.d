...
- helpful
- backup-by-copying t 
- (setq auto-save-visited-interval 60) (auto-save-visited-mode 1)
...
(defun initial-yafolding()
  (interactive)

  (save-excursion
    (goto-char (point-min))
    (while (search-forward "*yafolding-hide-parent*" nil t 1)
      (yafolding-hide-parent-element)))

    (goto-char (point-min))
    (while (search-forward "*yafolding-hide-next-line*" nil t 1)
      (forward-line)
      (yafolding-hide-element))

    (goto-char (point-min))
    (while (search-forward "*yafolding-hide*" nil t 1)
      (yafolding-hide-element)))

(add-hook 'find-file-hook 'initial-yafolding)
...
(add-to-list 'origami-parser-alist '( shell-script-mode . origami-parser-imenu-flat ))
#+end_src
