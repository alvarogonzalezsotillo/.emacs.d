...
(defun centaur-tabs--groups-menu ()
  ...
  (let*
    ...
    (define-key centaur-tabs-default-map (kbd "<header-line> <triple-mouse-5>") 'centaur-tabs-forward )
    (define-key centaur-tabs-default-map (kbd "<header-line> <triple-mouse-4>") 'centaur-tabs-backward )
    (define-key centaur-tabs-mode-map (kbd "<header-line> <mouse-3>") 'centaur-tabs--groups-menu )
...
- https://github.com/ema2159/centaur-tabs/blob/master/README.org
