...
#+begin_src emacs-lisp
  (use-package centaur-tabs
    ...
    (define-key centaur-tabs-default-map (kbd "<header-line> <triple-mouse-4>") 'centaur-tabs-forward )
    (define-key centaur-tabs-default-map (kbd "<header-line> <triple-mouse-5>") 'centaur-tabs-backward )
...
#+begin_src emacs-lisp
  (save-place-mode 1)
  (delete-file (expand-file-name "~/.emacs.d/.emacs.desktop.lock"))
